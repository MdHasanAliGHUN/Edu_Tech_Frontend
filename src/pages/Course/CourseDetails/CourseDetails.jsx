...
import { data } from "../CourseCards/CourseCards";
...
const CourseDetails = () => {
  ...
  return (
    <div className="container max-w-7xl mx-auto px-6 py-8 text-white">
      {/* Back Link */}
      <NavLink
        to="/courses"
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/3 space-y-4 bg-zinc-900 p-4 rounded-lg shadow-lg">
          ...
          <p className="text-gray-200 text-sm mt-2 font-semibold">Requirements:</p>
