...
const Footer = () => {
  return (
    <footer className="bg-linear-to-r from-indigo-900 via-gray-900 to-indigo-900 text-gray-300 py-12 ">
      <div className="container max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mt-2 text-sm md:text-base text-gray-400 font-playfair">
            Your trusted platform for learning, growing, and excelling in web
